    ...
    <div class="box zoom-in">
      ...
      >
        <div class="box">
            ...
            >
              ...
              <div class="absolute bottom-0 text-white px-5 pb-5 z-10">
                ...
                <span class="text-white/90 text-xs font-medium mt-3">
                  {{ moment(detail.periode_bulanan).format("MMMM YYYY") }}</span
                >
              </div>
            </div>
          ...
          >
            <a
              class="flex items-center text-xs text-primary mr-auto"
              href="javascript:;"
            >
              Diedit:
              {{ moment(detail.tanggal_update).format("DD/MM/YYYY HH:SS") }}
            </a>
            <a
